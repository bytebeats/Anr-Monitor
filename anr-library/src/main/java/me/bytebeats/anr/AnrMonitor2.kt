 ...
 */
class AnrMonitor2(private val timeoutInterval: Long = DEFAULT_ANR_TIMEOUT) :
  ...
  fun setAnrListener(anrListener: AnrListener?): AnrMonitor2 {
    mAnrListener = anrListener ?: DEFAULT_ANR_LISTENER
    return this
  }

  fun setAnrInterceptor(anrInterceptor: AnrInterceptor?): AnrMonitor2 {
   ...
   */
  fun setReportThreadNamePrefix(prefix: String): AnrMonitor2 {
    mPrefix = prefix
    return this
  }
   ...
   * @return itself for chaining.
   */
  fun setReportMainThreadOnly(): AnrMonitor2 {
    mPrefix = null
    return this
  }
   ...
   * @return itself for chaining.
   */
  fun setReportAllThreads(): AnrMonitor2 {
    mPrefix = ""
    return this
  }
   ...
   * @return itself for chaining.
   */
  fun setLogThreadWithoutStackTrace(logThreadsWithoutStackTrace: Boolean): AnrMonitor2 {
   ...
   * @return itself for chaining.
   */
  fun setIgnoreDebugger(ignoreDebugger: Boolean): AnrMonitor2 {
